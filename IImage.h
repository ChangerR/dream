...
public:
	...
	virtual const dimension2d<u32>& getDimension() const = 0;
	...
	virtual void copyTo(IImage* target, const position2d<s32>& pos=position2d<s32>(0,0)) =0;

	//! copies this surface into another
	virtual void copyTo(IImage* target, const position2d<s32>& pos, const rectangle<s32>& sourceRect, const rectangle<s32>* clipRect=0) =0;

	//! copies this surface into another, using the alpha mask and cliprect and a color to add with
	virtual void copyToWithAlpha(IImage* target, const position2d<s32>& pos,
			const rectangle<s32>& sourceRect, const SColor &color,
			const rectangle<s32>* clipRect = 0) =0;
