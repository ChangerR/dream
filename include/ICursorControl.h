...
public:
	...
	virtual void setPosition(const position2d<f32> &pos) = 0;
	...
	virtual void setPosition(const position2d<s32> &pos) = 0;
	...
	virtual const position2d<s32>& getPosition() = 0;
	...
	the top left corner and (1.0f, 1.0f) is the bottom right corner of the
	render window. */
	virtual position2d<f32> getRelativePosition() = 0;
	...
	virtual void setReferenceRect(rectangle<s32>* rect=0) = 0;
	...
	virtual ECURSOR_ICON getActiveIcon() const { return ECI_NORMAL; }

	//! Add a custom sprite as cursor icon.
	/** \return Identification for the icon */
	virtual ECURSOR_ICON addIcon(const SCursorSprite& icon) { return ECI_NORMAL; }
	...
	*/
	virtual void changeIcon(ECURSOR_ICON iconId, const SCursorSprite& sprite) {}

	//! Return a system-specific size which is supported for cursors. Larger icons will fail, smaller icons might work.
	virtual dimension2di getSupportedIconSize() const { return dimension2di(0,0); }
