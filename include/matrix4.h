...
class CMatrix4
{
	public:
		...
		CMatrix4<T>& buildNDCToDCMatrix( const rectangle<s32>& area, f32 zScale);
...
template <class T>
inline CMatrix4<T>& CMatrix4<T>::buildNDCToDCMatrix( const rectangle<s32>& viewport, f32 zScale)
{
