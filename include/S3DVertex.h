...
enum E_VERTEX_TYPE
{
	...
	//! Vertex with a tangent and binormal vector, S3DVertexTangents.
...
struct S3DVertex
{
	...
	//! constructor
	S3DVertex(const vector3df& pos, const vector3df& normal,
...
struct S3DVertex2TCoords : public S3DVertex
{
	...
	S3DVertex2TCoords(const vector3df& pos, SColor color,
		...
		: S3DVertex(pos, vector3df(), color, tcoords), TCoords2(tcoords2) {}
...
struct S3DVertexTangents : public S3DVertex
{
	...
	//! constructor
	S3DVertexTangents(const vector3df& pos, SColor c,
		const vector2df& tcoords)
		: S3DVertex(pos, vector3df(), c, tcoords) { }

	//! constructor
	S3DVertexTangents(const vector3df& pos,
		const vector3df& normal, SColor c,
		const vector2df& tcoords,
