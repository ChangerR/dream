...
public:
	...
	virtual dimension2d<u32> getVideoModeResolution(s32 modeNumber) const = 0;
	...
	as good as possible. */
	virtual dimension2d<u32> getVideoModeResolution(const dimension2d<u32>& minSize, const dimension2d<u32>& maxSize) const = 0;
	...
	virtual const dimension2d<u32>& getDesktopResolution() const = 0;
