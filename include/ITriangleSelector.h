...
/** Every INode may have a triangle selector, available with
INode::getTriangleScelector() or ISceneManager::createTriangleSelector.
...
public:
	...
	virtual void getTriangles(triangle3df* triangles, s32 arraySize,
		s32& outTriangleCount, const matrix4* transform=0) const = 0;
	...
	transformation will be done. */
	virtual void getTriangles(triangle3df* triangles, s32 arraySize,
		s32& outTriangleCount, const aabbox3d<f32>& box,
	...
	transformation will be done. */
	virtual void getTriangles(triangle3df* triangles, s32 arraySize,
		s32& outTriangleCount, const line3d<f32>& line,
		const matrix4* transform=0) const = 0;
	...
	*/
	virtual INode* getNodeForTriangle(u32 triangleIndex) const = 0;
