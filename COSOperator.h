...
public:
	...
	COSOperator(const stringc& osversion, CDreamDeviceLinux* device);
#endif
 	COSOperator(const stringc& osversion);

	//! returns the current operation system version as string.
	virtual const stringc& getOperatingSystemVersion() const;
