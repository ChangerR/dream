...
CImage::CImage(ECOLOR_FORMAT format, const dimension2d<u32>& size)
...
CImage::CImage(ECOLOR_FORMAT format, const dimension2d<u32>& size, void* data,
...
const dimension2d<u32>& CImage::getDimension() const
{
	return Size;
}
...
void CImage::copyTo(IImage* target, const position2d<s32>& pos)
{
...
void CImage::copyTo(IImage* target, const position2d<s32>& pos, const rectangle<s32>& sourceRect, const rectangle<s32>* clipRect)
{
...
void CImage::copyToWithAlpha(IImage* target, const position2d<s32>& pos, const rectangle<s32>& sourceRect, const SColor &color, const rectangle<s32>* clipRect)
{
...
{
	const dimension2d<u32> destSize = target->getDimension();
