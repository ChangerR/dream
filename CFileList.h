...
public:
	...
	virtual u32 addItem(const path& fullPath, u32 offset, u32 size, bool isDirectory, u32 id=0);
	...
	virtual const path& getFileName(u32 index) const;

	//! Gets the full name of a file in the list, path included, based on an index.
	virtual const path& getFullFileName(u32 index) const;
	...
	virtual s32 findFile(const path& filename, bool isFolder) const;
