...
public:
	...
	COGLES2MaterialRenderer_SOLID( COGLES2Driver* d ) :
...
public:
	...
	COGLES2MaterialRenderer_ONETEXTURE_BLEND( COGLES2Driver* d )
			: COGLES2MaterialRenderer( d ) {}
...
public:
	...
	COGLES2MaterialRenderer_SOLID_2_LAYER( COGLES2Driver* d )
			: COGLES2MaterialRenderer( d ) {}
...
public:
	...
	COGLES2MaterialRenderer_TRANSPARENT_ADD_COLOR( COGLES2Driver* d )
			: COGLES2MaterialRenderer( d ) {}
...
public:
	...
	COGLES2MaterialRenderer_TRANSPARENT_VERTEX_ALPHA( COGLES2Driver* d )
			: COGLES2MaterialRenderer( d ) {}
...
public:
	...
	COGLES2MaterialRenderer_TRANSPARENT_ALPHA_CHANNEL( COGLES2Driver* d )
			: COGLES2MaterialRenderer( d ) {}
...
public:
	...
	COGLES2MaterialRenderer_TRANSPARENT_ALPHA_CHANNEL_REF( COGLES2Driver* d )
			: COGLES2MaterialRenderer( d ) {}
...
public:
	...
	COGLES2MaterialRenderer_LIGHTMAP( COGLES2Driver* d )
			: COGLES2MaterialRenderer( d ) {}
...
public:
	...
	COGLES2MaterialRenderer_DETAIL_MAP( COGLES2Driver* d )
			: COGLES2MaterialRenderer( d ) {}
...
public:
	...
	COGLES2MaterialRenderer_SPHERE_MAP( COGLES2Driver* d )
			: COGLES2MaterialRenderer( d ) {}
...
public:
	...
	COGLES2MaterialRenderer_REFLECTION_2_LAYER( COGLES2Driver* d )
			: COGLES2MaterialRenderer( d ) {}
...
public:
	...
	COGLES2MaterialRenderer_TRANSPARENT_REFLECTION_2_LAYER( COGLES2Driver* d )
			: COGLES2MaterialRenderer( d ) {}
